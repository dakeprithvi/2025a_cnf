...
$(FOURUP_PDF) : %-4up.pdf : $(BUILD_DIR)/%-handout.pdf
	@echo Building $@.
	@pdfjam --preamble '\pdfinclusioncopyfonts=1' --quiet --letterpaper --scale 0.95 --landscape --nup 2x2 --delta "5mm 5mm" -o $@ $<
...
$(INKSCAPE_FLAG) : $(BUILD_DIR)/%.inkscape : %.svg
	...
	$(INKSCAPE) --export-filename=$(BUILD_DIR)/$*.pdf --export-latex $<
